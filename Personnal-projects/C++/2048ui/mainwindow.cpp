    ...
    ui(new Ui::MainWindow)
{
    ...
    create_actions(); // 这三个都需要来显示toolbar
    create_menus();
...
void MainWindow::on_about_game(){
    QString introduction(
        ...
        + "<p>" + tr("Please see ")+"<a href=http://www.gnu.org/licenses/gpl-3.0.html>http://www.gnu.org/licenses/gpl-3.0.html</a>"+tr(" to find more interesting personnal projects by me")+"</p>"
